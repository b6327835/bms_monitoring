...
function App() {
  ...
  const DraggablePanel = React.memo(({ panelId, title, position, setPosition, minimized, setMinimized, onClose, width = 280, children }) => {
    ...
    return (
      <Draggable
        ...
        handle=".drag-handle"
      >
        <div ref={nodeRef} style={{ position: 'absolute', width, background: 'rgba(17,24,39,0.95)', color: '#e5e7eb', borderRadius: 10, boxShadow: '0 10px 30px rgba(0,0,0,0.45)', border: '1px solid #1f2937', zIndex: 3, overflow: 'hidden' }}>
          ...
          <div 
            ...
            style={minimized ? { padding: 0, maxHeight: 0, overflow: 'hidden' } : { padding: 8, maxHeight: '58vh', overflow: 'auto' }}
          >
            {children}
          </div>
        </div>
    ...
    <div className="App">
      <div style={{ width: '100vw', height: '100vh', position: 'relative' }}>
        ...
        <div style={{ position: 'absolute', bottom: '16px', left: '16px', display: 'flex', gap: '8px', zIndex: 4, background: 'rgba(17,24,39,0.6)', padding: 6, borderRadius: 10, border: '1px solid #1f2937', boxShadow: '0 8px 20px rgba(0,0,0,0.35)' }}>
          ...
          <button title="Filter" onClick={() => setFilterVisible((v) => !v)} style={{ width: 32, height: 32, borderRadius: 6, border: '1px solid #374151', background: '#111827', color: '#e5e7eb', fontWeight: 700, fontSize: 11, cursor: 'pointer' }}>F</button>
          <button title="Equipment" onClick={() => setEquipmentPanelOpen((v) => !v)} style={{ width: 32, height: 32, borderRadius: 6, border: '1px solid #374151', background: '#111827', color: '#e5e7eb', fontWeight: 700, fontSize: 11, cursor: 'pointer' }}>E</button>
          <button title="EV Panel" onClick={() => setEvPanelOpen((v) => !v)} style={{ width: 32, height: 32, borderRadius: 6, border: '1px solid #374151', background: '#111827', color: '#e5e7eb', fontWeight: 700, fontSize: 11, cursor: 'pointer' }}>EV</button>
        </div>
        ...
        <div style={{ position: 'absolute', bottom: '16px', right: '16px', display: 'flex', gap: '8px', zIndex: 4, background: 'rgba(17,24,39,0.6)', padding: 6, borderRadius: 10, border: '1px solid #1f2937', boxShadow: '0 8px 20px rgba(0,0,0,0.35)' }}>
          <button title="Accident" onClick={() => setAccidentOpen((v) => !v)} style={{ width: 32, height: 32, borderRadius: 6, border: '1px solid #7f1d1d', background: '#7f1d1d', color: 'white', fontWeight: 800, fontSize: 11, cursor: 'pointer' }}>A</button>
        </div>
        ...
        {accidentOpen && (
          <DraggablePanel panelId="accident" title="Accident Controls" position={accidentPos} setPosition={setAccidentPos} minimized={accidentMin} setMinimized={setAccidentMin} onClose={closeAccident} width={260}>
        ...
        {/* Sidebar (draggable) */}
        {sidebarVisible && (
          <DraggablePanel panelId="sidebar" title="Sidebar" position={sidebarPos} setPosition={setSidebarPos} minimized={sidebarMin} setMinimized={setSidebarMin} onClose={closeSidebar} width={280}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              <button onClick={() => { setEquipmentPanelType('chiller'); setEquipmentPanelOpen(true); }} style={{ background: '#0b1220', color: '#e5e7eb', border: '1px solid #1f2937', borderRadius: '8px', padding: '8px', display: 'flex', justifyContent: 'space-between', cursor: 'pointer', fontSize: 12 }}>
              ...
              <button onClick={() => { setEquipmentPanelType('ahu'); setEquipmentPanelOpen(true); }} style={{ background: '#0b1220', color: '#e5e7eb', border: '1px solid #1f2937', borderRadius: '8px', padding: '8px', display: 'flex', justifyContent: 'space-between', cursor: 'pointer', fontSize: 12 }}>
              ...
              <button onClick={() => { setEquipmentPanelType('electrical'); setEquipmentPanelOpen(true); }} style={{ background: '#0b1220', color: '#e5e7eb', border: '1px solid #1f2937', borderRadius: '8px', padding: '8px', display: 'flex', justifyContent: 'space-between', cursor: 'pointer', fontSize: 12 }}>
              ...
              <button onClick={() => { setEquipmentPanelType('pump'); setEquipmentPanelOpen(true); }} style={{ background: '#0b1220', color: '#e5e7eb', border: '1px solid #1f2937', borderRadius: '8px', padding: '8px', display: 'flex', justifyContent: 'space-between', cursor: 'pointer', fontSize: 12 }}>
              ...
              <button onClick={() => { setEquipmentPanelType('fire'); setEquipmentPanelOpen(true); }} style={{ background: '#0b1220', color: '#e5e7eb', border: '1px solid #1f2937', borderRadius: '8px', padding: '8px', display: 'flex', justifyContent: 'space-between', cursor: 'pointer', fontSize: 12 }}>
              ...
              <button onClick={() => setEvPanelOpen(true)} style={{ background: '#0b1220', color: '#e5e7eb', border: '1px solid #1f2937', borderRadius: '8px', padding: '8px', display: 'flex', justifyContent: 'space-between', cursor: 'pointer', fontSize: 12 }}>
        ...
        {filterVisible && (
          <DraggablePanel panelId="filter" title="Show Equipment" position={filterPos} setPosition={setFilterPos} minimized={filterMin} setMinimized={setFilterMin} onClose={closeFilter} width={240}>
        ...
        {/* EV Panel (draggable) */}
        {evPanelOpen && (
          <DraggablePanel panelId="ev" title="EV Charging Status" position={evPanelPos} setPosition={setEvPanelPos} minimized={evPanelMin} setMinimized={setEvPanelMin} onClose={closeEV} width={520}>
